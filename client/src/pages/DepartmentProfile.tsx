...
const DepartmentProfile: React.FC = () => {
    ...
    useEffect(() => {
        if (user) {
            setFormData({
                name: user.name || '',
                email: user.email || '',
                departmentName: user.departmentName || DEPARTMENTS[0]
            });
        }
    }, [user]);
    ...
    return (
        <div className="max-w-2xl mx-auto">
            <h1 className="text-3xl font-bold mb-6">My Department Profile</h1>
            <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md">
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                        <label htmlFor="departmentName" className="block text-sm font-medium text-gray-700 dark:text-gray-300">Department</label>
                        <select
                            id="departmentName"
                            name="departmentName"
