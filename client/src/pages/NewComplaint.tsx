...
const NewComplaint: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const success = await addComplaint(complaintData);
            
            if (success) {
                addNotification('Complaint submitted successfully! AI is assigning priority.', 'success');
                if (user.role === Role.Department) {
            ...
            // No else needed as DataContext handles error notifications
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div>
                        ...
                        <textarea
                            ...
                            required
                        />
                         <p className="mt-2 text-xs text-gray-500 dark:text-gray-400">An AI will automatically assign a priority to this ticket based on your description.</p>
                    </div>
